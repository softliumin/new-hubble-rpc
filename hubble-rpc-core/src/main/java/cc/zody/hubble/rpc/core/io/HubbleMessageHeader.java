...
import cc.zody.hubble.rpc.core.HubbleConstant;
...
public class HubbleMessageHeader implements Cloneable {
    ...
    public HubbleMessageHeader setValues(int protocolType, int codecType, int msgType, int compressType, int msgId) {
        this.msgId = msgId;
